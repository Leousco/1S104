...
<style>
:root{--paypal-gold:#0070ba;--muted:#6b7280;}
html,body{height:100%;margin:0;font-family:Inter, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial;}
body{background:#f0f6ff;display:flex;align-items:center;justify-content:center;padding:20px;}
...
.phone .header { background: var(--paypal-gold); color: #fff; padding:14px 16px; display:flex; align-items:center; justify-content:space-between; }
...
.merchant .logo { width:56px; height:56px; border-radius:12px; background:linear-gradient(135deg,#e3f2fd,#bbdefb); display:flex; align-items:center; justify-content:center; color:var(--paypal-gold); font-weight:700; font-size:20px; }
...
input[type="email"]{ width:100%; padding:12px; border-radius:8px; border:1px solid #e6eefc; font-size:15px; outline:none; box-sizing:border-box; }
.pay-btn{ width:100%; margin-top:12px; background:var(--paypal-gold); color:#fff; padding:12px; border-radius:10px; font-size:16px; border:0; cursor:pointer; box-shadow: 0 6px 18px rgba(0,112,186,0.15); }
...
<body>
<div class="phone" role="main" aria-label="PayPal demo payment">
  <div class="header">
  ...
  <div class="body">
    <div class="merchant">
      ...
      <div>
        <div class="meta"><b>ABC Transport Co.</b> Pay with PayPal</div>
    ...
    <form id="paypalForm" method="POST" autocomplete="off">
      <input type="hidden" id="ticket_id" name="ticket_id" value="<?php echo (int)$row['TicketID']; ?>">
      <div class="form-row">
        <label for="paypal_email">PayPal Email</label>
        <input id="paypal_email" name="paypal_email" type="email" placeholder="your@email.com" required>
      </div>
  ...
  <div class="footer">PayPal Demo • ABC Transport Co.</div>
</div>
